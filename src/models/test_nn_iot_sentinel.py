...
from train_nn_iot_sentinel import SimpleNN, IoTSentinelDataset
...
def main():
    ...
    target_col = 'device_name'
    
    # Remove uniquely identifying values/features
    drop_cols = ['setup_id', 'device_mac', 'time', 'src_mac', 'dst_mac', 
    ...
    model_dir = 'models/trained/iot_sentinel'
    ...
    test_dataset = IoTSentinelDataset(X_test_scaled, y_test_encoded)
